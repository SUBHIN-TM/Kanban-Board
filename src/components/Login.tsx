...
const Login = () => {
    ...
    const inputsGetting =(e:React.ChangeEvent<HTMLInputElement>)=>{
  ...
  return (
    <div className='loginDiv flex items-center justify-center h-screen'>
      ...
      <form>
        ...
        <p onClick={()=>navigate('/register')} className='italic mt-3 cursor-pointer hover:text-blue-500 hover:underline'>Create Your Account ➡️</p>
      </form>
    </Container>
    </div>
